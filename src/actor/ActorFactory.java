 ...
 * @author Rex Woollard | Edit's made by Liam McGovern on March 2 2014.
 *
 * @see Actor
 */
public final class ActorFactory {
    ...
    public enum Type {
        ...
        HUMAN()			{ @Override public Actor create(Army armyAllegiance) { return new Human(armyAllegiance); } },
